...
import 'package:survey/screens/business_nonFinancial/business_nonfinancial_settwo/business_nonfinancial_settwo_controller.dart';
import 'package:survey/screens/detail_screen.dart';
import 'package:survey/utility/checkConnectivity.dart';
import 'package:get_storage/get_storage.dart';

class BusinessNonfinancialSettwoScreen extends StatelessWidget {
  final String userId;
  bool flag = true;
  BusinessNonfinancialSettwoScreen({super.key, required this.userId});

  @override
  Widget build(BuildContext context) {
    final BusinessNonfinancialSettwoController surveyController =
        Get.put(BusinessNonfinancialSettwoController());
      ...
      body: Obx(() {
        ...
        return Form(
          ...
          child: ListView.builder(
            ...
            itemCount: surveyController.business_survey_questions_settwo.length,
            itemBuilder: (context, index) {
              var question =
                  surveyController.business_survey_questions_settwo[index];
                ...
                if (isConnected) {
                  ...
                  if (flag) {
                    for (int i = 0;
                        i <
                            surveyController
                                .business_survey_questions_settwo.length;
                        i++) {
                      var question =
                          surveyController.business_survey_questions_settwo[i];
